            ...
            <ng-template pTemplate="emptymessage">
              <tr>
                <td colspan="5" class="text-center py-8">
                  <i
                    class="pi pi-info-circle text-4xl text-gray-400 mb-4 block"
                  ></i>
        ...
        <form [formGroup]="settingForm" (ngSubmit)="saveSetting()">
          <div class="field">
            ...
            <small
              class="p-error"
              *ngIf="
                settingForm.get('key')?.invalid &&
                settingForm.get('key')?.touched
              "
            >
              Key is required
            </small>
          ...
          <div class="field mt-4">
            ...
            <small
              class="p-error"
              *ngIf="
                settingForm.get('description')?.invalid &&
                settingForm.get('description')?.touched
              "
            >
          ...
          <div class="field mt-4">
            ...
            <small
              class="p-error"
              *ngIf="
                settingForm.get('value')?.invalid &&
                settingForm.get('value')?.touched
              "
            >
              Value is required
            </small>
...
export class SettingsComponent implements OnInit, OnDestroy {
  ...
  saveSetting() {
    ...
    const operation =
      this.editMode && this.selectedSetting
        ? this.settingsService.updateSetting(
            this.selectedSetting._id,
            settingData,
          )
